...
if($resultado_id) {
    ...
    while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
        ...
        echo '<button type="button" id="btn_deixar_seguir_'.$registro['id'].'" style="display:'.$btn_deixar_seguir_display.'" class="btn btn-primary btn_deixar_seguir pull-right" data-id_usuario="'.$registro['id'].'"> Deixar de Seguir </button>';
        echo '<button type="button" id="btn_seguir_'.$registro['id'].'" style="display:'. $btn_seguir_display.'" class="btn btn-default btn_seguir pull-right" data-id_usuario="'.$registro['id'].'"> Seguir </button>';
